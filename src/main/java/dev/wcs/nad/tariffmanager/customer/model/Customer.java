...
public abstract class Customer {
    ...
    // This method is abstract and MUST NOT be implemented here - therefore the
    // missing body.
    // This method MUST be implemented by non-abstract subclasses of this super
    // class.
    public abstract double calculateDiscountedPrice(int value);

    // This method is specified for all subclasses of this super class.
    // If this method is not overridden, it valid on all subclasses as specified
    // here.
    public String whoAmI() {
        return "Hi there, I am a " + this.getClass().getName() + " and my name is '" + getName() + "'";
    }

    // This method is set to false as default. If specific subclasses want to change
    // the behaviour, they can explicitly override this method (see VICustomer).
     ...
     *
     * 
     * public Customer(String id, String name, String email, LocalDate birthDate,
