...
public class CustomerImporter {
    ...
    private final int viCustomerDiscountPercentage;
    // Challenge: Add other discount percentage here and as constructor-injected
    // parameter

    // public CustomerImporter(@Value("${junior.customer.discount.percent}") int
    // juniorCustomerDiscountPercentage) {
    // this.juniorCustomerDiscountPercentage = juniorCustomerDiscountPercentage;
    // }

    public CustomerImporter(@Value("${vi.customer.discount.percent}") int viCustomerDiscountPercentage,
            @Value("${junior.customer.discount.percent}") int juniorCustomerDiscountPercentage) {
        this.viCustomerDiscountPercentage = viCustomerDiscountPercentage;
        this.juniorCustomerDiscountPercentage = juniorCustomerDiscountPercentage;
    }
    ...
    private Customer parseCsvLineIntoObject(String id, String name, String email, String birthDay, String lastBuy,
        ...
        try {
            ...
            switch (type.toUpperCase()) {
                ...
                case "V": {
                    VICustomer viCustomer = new VICustomer(viCustomerDiscountPercentage, id, name, email, birthDate,
                            lastBuyDate);
                    return viCustomer;
                }
                case "S": {
